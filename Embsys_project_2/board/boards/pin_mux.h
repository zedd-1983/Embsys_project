...
/*! @name PORTB2 (number 55), J4[2]
  @{ */
#define BOARD_ENC_BUTTON_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_ENC_BUTTON_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_ENC_BUTTON_PIN 2U     /*!<@brief PORTB pin index: 2 */
                                    /* @} */

/*! @name PORTB3 (number 56), J4[4]
  @{ */
#define BOARD_ENC_DT_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_ENC_DT_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_ENC_DT_PIN 3U     /*!<@brief PORTB pin index: 3 */
                                /* @} */

/*! @name PORTB10 (number 58), J4[6]
  @{ */
#define BOARD_ENC_CLK_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_ENC_CLK_PORT PORTB /*!<@brief PORT device name: PORTB */
